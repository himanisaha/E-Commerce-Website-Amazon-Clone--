            ...
            <div className="mb-3 border-top pt-3">
              ...
              {isHighlightsOpen && (
                <div>
                  ...
                  <ul>
                    <li><strong>Premium Fabric</strong> – Crafted using high-quality nylon material with leather accents, giving the backpack a stylish look while remaining lightweight, water-resistant, and long-lasting.</li>
                    <li><strong>Compact yet Spacious</strong> – Designed in a practical size with ample storage to carry a laptop, tablet, books, accessories, water bottle, and daily essentials comfortably.</li>
                    <li><strong>Smart Storage Design</strong> – Features multiple exterior and interior pockets, including zip compartments and dedicated sections to keep belongings organized.</li>
                    <li><strong>Comfort-Focused Build</strong> – Padded shoulder straps and cushioned back support reduce strain, making it suitable for extended daily use.</li>
                    <li><strong>Versatile Usage</strong> – Ideal for office, college, travel, and outdoor activities with a clean, modern appearance that suits every setting.</li>
                  </ul>
          ...
          <section className="mb-5">
            ...
            <div className="row row-cols-1 row-cols-md-2 g-3">
              <div className="col border p-3 rounded">
                ...
                <p>“Very comfortable straps even when fully loaded.”</p>
              </div>
              <div className="col border p-3 rounded">
                <strong>Quality</strong>
                <p>“Material is premium & waterproof.”</p>
              </div>
              <div className="col border p-3 rounded">
                <strong>Value</strong>
              ...
              <div className="col border p-3 rounded">
                <strong>Space</strong>
                <p>“Fits everything including my laptop.”</p>
              </div>
            </div>
          </section>
            ...
            <div className="row">
              ...
              <div className="col-md-9">
                ...
                <div className="border p-3 rounded mb-3">
                  ...
                  <p>“Loved it. Premium material and very comfortable.”</p>
                  <small className="text-muted">Reviewed in India on 2 Jan 2025</small>
                </div>
